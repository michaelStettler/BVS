...
if __name__ == '__main__':
    ...
    # append results
    out = {}
    out['train_accuracies'] = metrics['train_accuracies']
    out['test_accuracies'] = metrics['test_accuracies']
    out['starting_acc'] = metrics['starting_acc']

    # save results
    save_name = '0' * (5 - len(str(n_sub))) + str(n_sub)
