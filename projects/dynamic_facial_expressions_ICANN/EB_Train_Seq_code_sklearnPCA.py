...
def train_model_seq(config):
    ...
    #      compute responses of RBF units for all training stimuli
    ...
    print('RBF neurons fire on average for ' + str(sig_fire * 100) + ' % of the training stimuli.')
    
    # Plot RBF section (until##)
    if do_plot > 0:
        plt.clf
        plt.cla
