...
def fit_NRE(x, y, n_cat, x_test=None, y_test=None, use_ref=True, batch_size=32, n_ref=1, init_ref=None, lr=0.01, n_epochs=20,
    ...
    if is_test_set:
        metrics = {'best_acc': best_acc, 'train_accuracies': train_accuracies, 'test_accuracies': test_accuracies, 'losses': losses}
    else:
        metrics = {'best_acc': best_acc, 'train_accuracies': train_accuracies, 'losses': losses}
