...
import json
import math
from models.layers.layers import GaborFiltersDynamic
...
for k, kernel in enumerate(kernels):
    ...
    cv2.imwrite("layers/video/gabor_filters_{}.jpeg".format(k), multi_frame.astype(np.uint8))
