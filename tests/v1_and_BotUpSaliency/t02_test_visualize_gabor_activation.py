...
import json
import math
from models.layers.layers import GaborFilters
from models.layers import create_multi_frame
from models.layers import create_multi_frame_heatmap
...
cv2.imwrite("layers/video/gabor_filters.jpeg", multi_frame.astype(np.uint8))
...
# plt.show()
cv2.imwrite("layers/video/heatmap_gabor_filters.jpeg", multi_frame.astype(np.uint8))
