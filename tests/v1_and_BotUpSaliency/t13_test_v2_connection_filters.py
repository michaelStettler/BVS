...
#
#     if verbose >= 2:
#         _save_multi_frame_from_multi_channel(W, "layers/video/v2_inibition_filter.jpeg")
#         _save_multi_frame_from_multi_channel(J, "layers/video/v2_exitatory_filter.jpeg")
#
#     return W, J
