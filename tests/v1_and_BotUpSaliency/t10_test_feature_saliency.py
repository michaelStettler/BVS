...
from models.layers import create_multi_frame_from_multi_channel
...
# cv2.imwrite("layers/video/W"+str(idx)+"_inibition_filter.jpeg", heatmap.astype(np.uint8))
#
...
# heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
# cv2.imwrite("layers/video/J"+str(idx)+"_exitatory_filter.jpeg", heatmap.astype(np.uint8))
...
heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
cv2.imwrite("layers/video/W_inibition_filter.jpeg", heatmap.astype(np.uint8))

# save J exitatory filters
multi_frame = create_multi_frame_from_multi_channel(J, num_row, num_column, (256, 256), num_input_channel)
heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
cv2.imwrite("layers/video/J_exitatory_filter.jpeg", heatmap.astype(np.uint8))
...
heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
cv2.imwrite("layers/video/0_00_I_i_theta.jpeg", heatmap.astype(np.uint8))
...
for t in range(2):
    ...
    if save_intermediate_img:
        ...
        multi_frame = create_multi_frame(x_print, num_row, num_column, (256, 256))
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_01_x.jpeg", heatmap.astype(np.uint8))
        # save gx activations
        gx_print = np.expand_dims(gx(x)[0], axis=2)
        multi_frame = create_multi_frame(gx_print, num_row, num_column, (256, 256))
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_02_gx(x)_response.jpeg", heatmap.astype(np.uint8))
    ...
    for i in range(n_rot):
        ...
        # multi_frame = create_multi_frame(W_print, num_row, num_column, (256, 256))
        # heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        # cv2.imwrite("layers/video/"+str(t)+"_W"+str(i)+"_inibition_filter.jpeg", heatmap.astype(np.uint8))
        #
        # J_print = np.swapaxes(J_print, 2, 3)
        # multi_frame = create_multi_frame(J_print, num_row, num_column, (256, 256))
        # heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        # cv2.imwrite("layers/video/"+str(t)+"_J"+str(i)+"_excitatory_filter.jpeg", heatmap.astype(np.uint8))
        #
        ...
        # cv2.imwrite("layers/video/"+str(t)+"_inhib" + str(i) + "_response.jpeg", heatmap.astype(np.uint8))
        #
        ...
        # cv2.imwrite("layers/video/"+str(t)+"_excit" + str(i) + "_response.jpeg", heatmap.astype(np.uint8))
    ...
    if save_intermediate_img:
        ...
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_03_i_norm.jpeg", heatmap.astype(np.uint8))
        # save inhibition
        ...
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_04_inibition_response.jpeg", heatmap.astype(np.uint8))
        # save excitation
        ...
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_05_exitatory_response.jpeg", heatmap.astype(np.uint8))
    ...
    if save_intermediate_img:
        ...
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_06_y_responses.jpeg", heatmap.astype(np.uint8))
        # print gy(y)
        gy_print = np.expand_dims(gy(y)[0], axis=2)
        multi_frame = create_multi_frame(gy_print, num_row, num_column, (256, 256))
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_07_gy(y)_response.jpeg", heatmap.astype(np.uint8))
    ...
    heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
    cv2.imwrite("layers/video/"+str(t)+"_08_inibition_psi.jpeg", heatmap.astype(np.uint8))
    ...
    if save_intermediate_img:
        ...
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_09_x_inhib_response.jpeg", heatmap.astype(np.uint8))

        x_excit_print = np.expand_dims(x_excit[0], axis=2)
        multi_frame = create_multi_frame(x_excit_print, num_row, num_column, (256, 256))
        heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
        cv2.imwrite("layers/video/"+str(t)+"_10_x_excit_response.jpeg", heatmap.astype(np.uint8))
    ...
    multi_frame = create_multi_frame(x_print, num_row, num_column, (256, 256))
    heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
    cv2.imwrite("layers/video/"+str(t)+"_11_V1_x_response.jpeg", heatmap.astype(np.uint8))

    x_print = np.expand_dims(gx(x)[0], axis=2)
    multi_frame = create_multi_frame(x_print, num_row, num_column, (256, 256))
    heatmap = cv2.applyColorMap(multi_frame, cv2.COLORMAP_VIRIDIS)
    cv2.imwrite("layers/video/"+str(t)+"_12_V1_gx(x)_response.jpeg", heatmap.astype(np.uint8))
...
cv2.imwrite("layers/video/V1_saliency_map.jpeg", heatmap.astype(np.uint8))
