...
from utils.get_csv_file_JAFFE import edit_JAFFE_csv_file_from_config
...
"""
run: python -m tests.LMK.t01b_optimize_JAFFE_lmks
"""
...
if __name__ == '__main__':
    ...
    # saving variables
    avatar_names = ['KA', 'KL', 'KM', 'KR', 'MK', 'NA', 'NM', 'TM', 'UY', 'YM']
    avatar_name = avatar_names[0]
    ...
    lmk_name = lmk_names[1]
    print("lmk_name:", lmk_name)


    save_path = r"C:\Users\Alex\Documents\Uni_Data\NRE\jaffedbase\saved_patterns"
    save_patterns_name = 'patterns_' + avatar_name + '_' + lmk_name
    save_sigma_name = 'sigma_' + avatar_name + '_' + lmk_name

    # define configuration
    config_path = 'LMK_t01_optimize_JAFFE_lmks_a0001.json'
    # load config
    ...
    edit_JAFFE_csv_file_from_config(config, avatar_name)
