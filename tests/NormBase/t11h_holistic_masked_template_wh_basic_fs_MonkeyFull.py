...
run: python -m tests.NormBase.t11h_holistic_masked_template_wh_basic_fs_MonkeyFull
"""

# define configuration
config_path = 'NB_t11h_holistic_masked_template_wh_basic_fs_Monkey_Full_m0001.json'
compute_NB = True
...
if test:
    ...
    # compute num test identities
    n_test_ids = int(len(test_data[0]) / config['n_category'])
    ...
    # add holistic templates
    test_rbf_template = [[[14, 17], [20, 23]], [[13, 16], [25, 27]], [[13, 16], [34, 36]], [[14, 17], [38, 41]],
                    [[33, 36], [23, 26]], [[33, 36], [29, 32]], [[33, 36], [34, 37]], [[35, 38], [29, 32]],
                    [[16, 20], [23, 26]], [[16, 20], [33, 36]]]
    test_rbf_mask = [[[12, 19], [18, 25]], [[12, 20], [23, 30]], [[11, 20], [32, 37]], [[12, 19], [33, 43]],
                    [[30, 43], [20, 28]], [[31, 37], [27, 34]], [[31, 40], [32, 42]], [[34, 46], [27, 33]],
                    [[12, 21], [22, 27]], [[12, 21], [33, 37]]]
    test_rbf_zeros = {'0': {'idx': 4, 'pos': [[31, 34], [25, 29]]}, '1': {'idx': 4, 'pos': [[42, 43], [20, 23]]}}
    config['rbf_sigma'] = [2300, 2700, 2740, 2280, 2870, 3540, 2815, 3200, 3120, 3120]
...
if plot:
    ...
    if test:
        ...
        ref_test_pos = []
        for i in range(n_test_ids):
            ref_test_pos.append(np.repeat(np.expand_dims(test_pos_2d[i * config['n_category']], axis=0),
                                          config['n_category'], axis=0))
